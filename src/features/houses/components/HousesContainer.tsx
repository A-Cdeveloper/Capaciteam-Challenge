...
type HousesContainerProps = {
  children: React.ReactNode;
  countText?: string;
};

/**
 * Shared container component for houses display with optional count text
 ...
 */
const HousesContainer = memo(({ children, countText }: HousesContainerProps) => {
  return (
